...
/**
 * Checkpoint - Represents a track obstacle to be avoided.
 * 
 * @package CodeRally
 * @version 1.0
 */
...
function Obstacle(obstacleState) {
    this.position = new Point(obstacleState.position.x, obstacleState.position.y);
